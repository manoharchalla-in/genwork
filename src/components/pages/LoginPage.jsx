...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50/50 via-slate-50 to-purple-50/40 text-slate-900 flex flex-col justify-between items-center p-4 sm:p-6 md:p-10 font-sans selection:bg-indigo-600 selection:text-white">
      ...
      <header className="w-full max-w-5xl mx-auto flex items-center justify-between py-4">
        <div className="flex items-center space-x-3">
          <div className="h-10 px-2.5 bg-white rounded-xl flex items-center justify-center border border-slate-200 shadow-xs">
            <img src="/genwork-logo.jpg" alt="Logo" className="h-7 object-contain rounded" />
          </div>
          <div>
            <span className="text-xl font-black tracking-wider text-slate-900">GEN-<span className="text-red-600">VNXV</span></span>
            <span className="block text-[10px] uppercase font-bold tracking-widest text-slate-500">Technologies</span>
          </div>
        </div>

        <div className="hidden sm:flex items-center space-x-2 text-xs font-extrabold text-slate-700 bg-white/80 backdrop-blur-md shadow-xs px-4 py-2 rounded-full border border-slate-200/80">
          <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
          <span>Placement & Readiness Portal</span>
        </div>
      </header>

      {/* Split Dual-Panel Card (Matching Gift Maya / Genmitra Layout) */}
      <main className="w-full max-w-5xl my-auto py-6">
        <div className="bg-white/90 backdrop-blur-xl rounded-[32px] border border-slate-200/90 shadow-2xl shadow-slate-950/5 overflow-hidden grid grid-cols-1 md:grid-cols-12 min-h-[520px]">
          
          {/* Left Panel: Brand & Value Proposition (Light Off-White / Soft Blue Tint) */}
          <div className="md:col-span-5 bg-gradient-to-b from-slate-50 to-slate-100/60 p-8 sm:p-10 border-b md:border-b-0 md:border-r border-slate-200/80 flex flex-col justify-between">
            <div className="space-y-6">
              {/* Logo / Mascot Badge */}
              <div className="inline-flex items-center space-x-3 bg-white p-3 rounded-2xl border border-slate-200 shadow-sm w-fit">
                <img src="/genwork-logo.jpg" alt="Genmitra Technologies" className="h-9 object-contain" />
              ...
              <div className="space-y-3.5 pt-2">
                <div className="flex items-center space-x-3 text-xs font-bold text-slate-700">
                  <div className="w-6 h-6 rounded-full bg-indigo-50 border border-indigo-100 flex items-center justify-center text-indigo-600 flex-shrink-0">
            ...
            <div className="pt-8 text-[11px] font-semibold text-slate-400">
          ...
          <div className="md:col-span-7 p-8 sm:p-12 flex flex-col justify-center bg-white">
            ...
            <div className="space-y-1 mb-8">
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs font-extrabold text-indigo-600 px-3 py-1 bg-indigo-50 rounded-full border border-indigo-100">
              ...
              <form onSubmit={handleStudentLogin} className="space-y-5">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50/80 border border-slate-200 focus:border-indigo-600 focus:bg-white rounded-xl px-4 py-3 text-sm text-slate-900 font-semibold outline-none transition-all"
                  />
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full bg-slate-50/80 border border-slate-200 focus:border-indigo-600 focus:bg-white rounded-xl px-4 py-3 text-sm text-slate-900 font-semibold outline-none transition-all pr-10"
                    />
                    <button
                      type="button"
                ...
                <div className="pt-2">
                  <button
                    type="submit"
                    className="w-full py-3.5 px-4 bg-indigo-600 hover:bg-indigo-700 text-white font-extrabold text-sm rounded-xl shadow-lg shadow-indigo-600/20 transition-all transform active:scale-[0.99] flex items-center justify-center space-x-2"
                  >
                    <span>Sign In</span>
                  </button>
                </div>
            ...
            {activePortalTab === 'admin' && (
              <form onSubmit={handleAdminLogin} className="space-y-5">
                ...
                <div className="p-3 rounded-xl bg-slate-50 border border-slate-200 text-slate-700 text-xs flex items-center space-x-2.5">
      ...
      {/* Footer */}
      <footer className="w-full max-w-5xl mx-auto py-2 text-center text-xs text-slate-400 font-medium">
