              ...
              <div className="flex items-center space-x-3">
                ...
                {!job.applied ? (
                  <button 
                    ...
                    className="px-5 py-2.5 bg-gradient-to-r from-emerald-950 via-teal-900 to-slate-900 text-white font-bold text-xs rounded-xl shadow-md hover:from-emerald-900 transition"
                  >
                    Apply Now (+25 Pts)
                  </button>
                ) : (
